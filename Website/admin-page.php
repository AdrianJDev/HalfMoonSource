...
<section id="content" class="login-form" style="color:#fff;">
	...
	<div class="container">
		...
		<div id="editableTable" class="section";>
			<form class="formValidate" id="formValidate1" method="post" action="routers/menu-router.php" novalidate="novalidate">
			<div class="row">
...
<section id="content" style="color:#fff;">
	<div class="container">
		<div class="section">
		<form class="formValidate" id="formValidate" method="post" action="routers/add-item.php" novalidate="novalidate">
				<div class="col s12 m4 l3">
				<br>
